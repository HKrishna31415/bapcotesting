    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 space-y-8">
      <header className="text-center">
        <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl md:text-6xl">
          Impact of Evaporation on Additives
        </h1>
        <p className="mt-3 max-w-md mx-auto text-base text-slate-400 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
          An interactive simulation showing how source gasoline evaporates while additives such as octane boosters and heavy aromatics remain within the tank.
        </p>
      </header>
